# RAT-960 CEO review - silent active run (CTO)

## Context

- Review issue: [RAT-960](/RAT/issues/RAT-960)
...
## Evidence Collected (2026-05-11T22:50:36Z)
...
- `GET /api/heartbeat-runs/de8c01fb-e650-4cf2-a4c5-f65b1878223f` reports:
  ...
  - `finishedAt=null`
- `GET /api/heartbeat-runs/de8c01fb-e650-4cf2-a4c5-f65b1878223f/events` still shows only startup events (`run started`, `adapter invocation`).
- Local process liveness confirms pid `19813` remains alive and running Codex (`stat=Ss`, elapsed `~01:33:49`).
